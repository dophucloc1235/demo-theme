...
<div class="main" style="margin-top:10px">
    <div class="text-danger text-center font-20 search-list">
        <?php
        $search_query = new WP_Query('s='.$s.'&showpost=-1');
        $search_keyword = wp_specialchars($s, 1);
        $search_count = $search_query->post_count;
        printf(__('Kết quả tìm thấy với: '.$s));
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <?php if ( have_posts() ) : ?>
                    ...
                    echo "<p style='font-size:30px;color:red;text-align:center;'>Chưa có nội dung</p>";
                endif;
                ?>
            </div>
